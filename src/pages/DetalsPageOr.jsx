...
const DetalsPageOr = () => {
    ...
    const {_id,title,location,rent,roomType,lifestylePreferences,description,contactInfo,availability,userEmail,userName,likeCount,photoUrl} = detals || {};
